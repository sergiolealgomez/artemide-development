...
public::artemide_SetEWparameters,artemide_SetDELTA,artemide_SetNewBoson
...
subroutine artemide_SetEWparameters(M_W,G_W)
    real*8::M_W,G_W,DELTANew
    
    call Set_EWparamters(M_W=M_W,G_W=G_W)
end subroutine artemide_SetEWparameters


subroutine artemide_SetDELTA(DELTANew)
    real*8,intent(in)::DELTANew
    call Set_DELTA(DELTANew)
end subroutine artemide_SetDELTA



subroutine artemide_SetNewBoson(MNew,GammaNew,RatioNew)
    real*8,intent(in)::MNew,GammaNew,RatioNew
    call Set_NeWBoson(MNew=MNew,GammaNew=GammaNew,RatioNew=RatioNew)
end subroutine artemide_SetNewBoson
